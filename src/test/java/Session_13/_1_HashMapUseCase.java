...
public class _1_HashMapUseCase {
	WebDriver driver;
		...
		public void invalidUser() 
		{
			...
			WebElement invalidpasswordFieldEle = driver.findElement(By.xpath("//input[@id='password']"));
			String invalidpassword = appCred().get("invalidUserName").split("#")[1];
			invalidpasswordFieldEle.sendKeys(invalidpassword);
